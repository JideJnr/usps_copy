...
const AdminTracking = () => {
  ...
  const handleAddUpdate = () => {
    setFormData({
      ...formData,
      updates: [...formData.updates, { date: "", location: "", status: "", description: "" }]
    });
  };
    ...
    <WhitePageLayout>
      <div className="w-full bg-gradient-to-br from-gray-900 to-gray-700 text-white">
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <h1 className="text-4xl font-bold mb-2">Admin - Create Tracking</h1>
          <p className="text-gray-100">Manage package tracking information</p>
        </div>
      </div>
